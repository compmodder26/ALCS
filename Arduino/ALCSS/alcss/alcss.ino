...
FlashStorage(stop_distance_store, int);


void setup() {
  stopDistance = stop_distance_store.read(); // get last light show preference reading before the device was turned off/restarted
...
void checkButtonPress() {
  ...
  if (currState == LOW && oldButtonState == HIGH) {
    ...
    stop_distance_store.write(stopDistance);
